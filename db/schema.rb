...
ActiveRecord::Schema.define(version: 20180103213335) do
  ...
  create_table "notifications", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["consumer_id"], name: "index_notifications_on_consumer_id"
  end
  ...
  add_foreign_key "notifications", "consumers"
end
